  ...
  <div class="row">
    ...
    <div class="col-lg-6 col-xs-6">
      <div class="small-box bg-aqua">
        ...
        <a href="<?= base_url('ortu/datasiswa') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    ...
    <div class="col-lg-6 col-xs-6">
      <div class="small-box bg-red">
        ...
        <a href="<?= base_url('ortu/pelanggaran') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
  </div>
      ...
      <div class="box box-danger">
        ...
        <div class="box-body">
          <div class="alert alert-danger alert-dismissible">
            ...
            Kamu memiliki satu panggilan Orang Tua Baru. <a href="<?= base_url('ortu/datapanggilan') ?>">Selengkapnya..</a>
          </div>
        </div>
      </div>
    </div>
